    ...
    <div class="app-container">
        ...
        <div class="table-container">
            <el-table ref="adminTable"
                ...
                <el-table-column label="更改时间" width="180" align="center">
                    <template slot-scope="scope">{{scope.row.updateDate}}</template>
                </el-table-column>
                </el-table-column>
                <el-table-column label="上传id" width="180" align="center">
...
<script>
    ...
    import {fetchList,deleteRecipecontent} from '@/api/recipe/recipeContent'
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                this.$router.push({path: '/recipe/updateRecipeContent', query: {id: row.id}})
            },
            handleDelete(index, row) {
                this.$confirm('是否要删除该记录', '提示', {
                    ...
                    deleteRecipecontent(row.id).then(response => {
                        this.$message({
                            message: '删除成功',
                            type: 'success',
                            duration: 1000
            ...
            addRecipeContent() {
                console.log(1);
                //
                this.$router.push({path: '/recipe/addrecipecontent'})
            }
        }
    }
</script>
