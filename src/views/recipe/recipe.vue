...
<script>
    ...
    import {fetchList, updateShowStatus, updateFactoryStatus, deleteRecipe} from '@/api/recipe/recipe'
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                this.$router.push({path: '/recipe/updateRecipe', query: {id: row.id}})
            },
            ...
            addRecipe() {
                this.$router.push({path: '/recipe/addRecipe'})
            }
        }
    }
</script>
