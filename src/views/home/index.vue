...
<div class="total-title">{{item.note}}</div>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">商品品类</div>
        ...
        <el-col :span="10">
          <div class="out-border">
            <div class="layout-title">商品数量</div>
        ...
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">溯源信息</div>
            <div style="padding: 20px">
              <el-row>
                <el-col :span="6" class="color-danger overview-item-value">{{0}}</el-col>
                <!--<el-col :span="6" class="color-danger overview-item-value">{{0}}</el-col>-->
    ...
    <div class="statistics-layout">
      <div class="layout-title">商品管理</div>
      <el-row>
        <el-col :span="4">
          <div style="padding: 20px">
            <div>
              <div style="color: #909399;font-size: 14px">商品数量总数</div>
            ...
            <div style="margin-top: 20px;">
              <div style="color: #909399;font-size: 14px">溯源信息</div>
