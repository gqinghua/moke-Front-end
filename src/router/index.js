...
export const constantRouterMap = [
    ...
    },
    {
        ...
        redirect: 'recipe',
        name: 'recipe',
        meta: {title: '食谱', icon: 'recipe'},
        children: [
            {
                path: 'indexrecipe',
                name: 'indexrecipe',
                component: () => import('@/views/recipe/recipe'),
                meta: {title: '食谱分类', icon: 'product-list'}
            },
            {
                path: 'addRecipe',
                name: 'addRecipe',
            ...
            },
            {
                path: 'updateRecipe',
                name: 'updateRecipe',
                component: () => import('@/views/recipe/update'),
                meta: {title: '修改食谱'},
                hidden: true
            },
            {
                path: 'indexrecipecontent',
                name: 'indexrecipecontent',
                component: () => import('@/views/recipecontent/recipecontent'),
                meta: {title: '食谱详情列表',icon: 'product-list'}
            },
            {
                path: 'addrecipecontent',
                name: 'addrecipecontent',
                component: () => import('@/views/recipecontent/add'),
                meta: {title: '添加食谱详情'},
                hidden: true
            },
            {
                path: 'updaterecipecontent',
                name: 'updaterecipecontent',
                component: () => import('@/views/recipecontent/update'),
                meta: {title: '修改食谱详情'},
                hidden: true
            }
        ]
